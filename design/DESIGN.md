...
2. **Motion storyboard** (`concepts/storyboard.png`, pending): six panels at 0 / 60 / 120 / 220 / 360 / 540 ms — idle; first pill pressed, row contracted 2px; thread halfway to the tray; thread arrived, tray reads `1 queued · Apply 1, one confirm`; row collapsed to the teal docket line `QUEUED · Started it · sumzup/digest-pipeline` with the next row renumbered to 1; folded seam opening with rotated chevron and two revealed rows.
